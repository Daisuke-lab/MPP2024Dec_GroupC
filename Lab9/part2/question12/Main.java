...
public class Main {
	...
	public static void main(String[] args) {
		...
		var resultNumEmployee = LambdaLibrary.NUM_EMPLOYEE_QUARY.apply(list);
		System.out.println(resultNumEmployee);
		...
		var resultSortedFullName = LambdaLibrary.SORTED_FULLNAME_QUARY.apply(list);
		System.out.println(resultSortedFullName);
	}
